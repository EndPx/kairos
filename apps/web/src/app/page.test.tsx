...
describe('HomePage', () => {
  it('presents the product boundary and routes evaluators to real evidence', () => {
    ...
    expect(screen.getByRole('heading', {name: /read-only preview/i})).toBeInTheDocument();
    expect(screen.getByText(/separately verified public create\/cancel history/i)).toBeInTheDocument();
