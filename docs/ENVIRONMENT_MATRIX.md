...
| Kuru | Monad Testnet MON-USDC market `0xa241896A7Dbe8a550D2E5fF7A914bB1989ceD2D9`; USDC `0x3bA3d39AFcf8bb994f7964B3e0171Ea2Ba361570`; local fork chain `31337` | Contracts `2060bb2736080c175d80d568bfdb6226bb5abd04`; SDK/ABI `636509c2eafd63479d3f399703354e0d09f51e18`; fork source block `62944132`, hash `0xb5a5a556...c914098`; deployed implementation remains source-unverified | Public Foundation RPC supports the fixed-block fork; optional `MONAD_RPC_URL` overrides it locally | ABI-compatible reads plus reproducible Hardhat EDR fork probe | PARTIAL (fork reads verified; settlement blocked) | Native MON base, USDC quote, scales/bounds/current fees and Margin Account linkage reproduced. Source book/vault were empty; controlled local liquidity and adapter settlement remain next |
